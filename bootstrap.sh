...
echo "thanks for installing xsy233's fork of spf13-vim"
...
if [ ! -e $endpath/.git ]; then
    ...
    git clone --recursive -b 3.0-new git@github.com:xsy233/spf13-vim.git $endpath
else
